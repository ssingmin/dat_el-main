...
FUNCTION_BLOCK MTBasicsPID (*PID controller.*)
	VAR_INPUT
		...
		HoldIntegration : MTBasicsPIDIntegrationEnum; (*PID parameters.*)
	END_VAR
	VAR_OUTPUT
		...
		IntegrationStatus : MTBasicsPIDIntegrationEnum; (*Derivative component.*)
...
FUNCTION_BLOCK MTBasicsStepTuning (*Step tuning for PID.*)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
